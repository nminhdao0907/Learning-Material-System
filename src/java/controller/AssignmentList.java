...
public class AssignmentList extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Assignmentsub> lstAsm = asmDAO.getAssignmentByUserId(user.getId());
        request.setAttribute("lstAsm", lstAsm);
        request.getRequestDispatcher("view/trainee/AssigntmentList.jsp").forward(request, response);
