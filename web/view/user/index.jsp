...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets_User/vendors/revolution/css/layers.css">
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets_User/vendors/revolution/css/settings.css">
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets_User/vendors/revolution/css/navigation.css">
...
<div id="loading-icon-bx"></div>
				...
				<div class="row d-flex justify-content-between">
					...
					<div class="topbar-right">
						<ul>
							...
							<li><a href="${pageContext.request.contextPath}/view/authen/login.jsp">Login</a></li>
							<li><a href="${pageContext.request.contextPath}/view/authen/register.jsp">Register</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="sticky-header navbar-expand-lg">
            <div class="menu-bar clearfix">
                <div class="container clearfix">
					<!-- Header Logo ==== -->
					<div class="menu-logo">
						<a href="index.html"><img src="assets_User/images/logo-white.png" alt=""></a>
					</div>
					<!-- Mobile Nav Button ==== -->
                    ...
                    <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
						<div class="menu-logo">
							<a href="index.html"><img src="assets_User/images/logo.png" alt=""></a>
						</div>
							...
							<li class="add-mega-menu"><a href="javascript:;">Our Courses <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu add-menu">
									...
									<li class="add-menu-right">
										<img src="assets_User/images/adv/adv.jpg" alt=""/>
									</li>
								</ul>
							</li>
    ...
    <div class="page-content bg-white">
				...
				<div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
					<ul>	<!-- SLIDE  -->
						...
						data-description="Science says that Women are generally happier">
							<!-- MAIN IMAGE -->
							<img src="assets_User/images/slider/slide1.jpg" alt="" 
						...
						data-easeout="default" 
						data-masterspeed="default" 
						data-thumb="assets_User/images/slider/slide1.jpg" 
						data-rotate="0" 
						data-fstransition="fade" 
						data-fsmasterspeed="1500" 
						data-fsslotamount="7" 
						...
						data-description="Science says that Women are generally happier">
							<!-- MAIN IMAGE -->
							<img src="assets_User/images/slider/slide2.jpg" alt="" 
								data-bgposition="center center" 
								data-bgfit="cover" 
								data-bgrepeat="no-repeat" 
								data-bgparallax="10" 
		...
		<div class="content-block">
                ...
                <div class="container">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								<div class="action-box">
									<img src="assets_User/images/our-services/pic1.jpg" alt="">
								</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								<div class="action-box">
									<img src="assets_User/images/our-services/pic2.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
						...
						<div class="col-lg-4 col-md-4 col-sm-12">
							<div class="service-bx m-b0">
								<div class="action-box">
									<img src="assets_User/images/our-services/pic3.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
                ...
                <div class="container">
					...
					<div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									<img src="assets_User/images/courses/pic1.jpg" alt="">
						...
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									<img src="assets_User/images/courses/pic2.jpg" alt="">
									<a href="#" class="btn">Read More</a>
								</div>
								<div class="info-bx text-center">
									<h5><a href="#">Introduction EduChamp ? LMS plugin</a></h5>
						...
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									<img src="assets_User/images/courses/pic3.jpg" alt="">
									<a href="#" class="btn">Read More</a>
								</div>
								<div class="info-bx text-center">
									<h5><a href="#">Introduction EduChamp ? LMS plugin</a></h5>
						...
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									<img src="assets_User/images/courses/pic4.jpg" alt="">
									<a href="#" class="btn">Read More</a>
								</div>
								<div class="info-bx text-center">
									<h5><a href="#">Introduction EduChamp ? LMS plugin</a></h5>
			...
			<!-- Form -->
			<div class="section-area section-sp1 ovpr-dark bg-fix online-cours" style="background-image:url(assets_User/images/background/bg1.jpg);">
				<div class="container">
					<div class="row">
				...
				<div class="container">
					...
					<div class="upcoming-event-carousel owl-carousel owl-btn-center-lr owl-btn-1 col-12 p-lr0  m-b30">
						<div class="item">
							<div class="event-bx">
								<div class="action-box">
									<img src="assets_User/images/event/pic4.jpg" alt="">
								</div>
						...
						<div class="item">
							<div class="event-bx">
								<div class="action-box">
									<img src="assets_User/images/event/pic3.jpg" alt="">
								</div>
								<div class="info-bx d-flex">
									<div>
										<div class="event-time">
						...
						<div class="item">
							<div class="event-bx">
								<div class="action-box">
									<img src="assets_User/images/event/pic2.jpg" alt="">
								</div>
								<div class="info-bx d-flex">
									<div>
										<div class="event-time">
			...
			<!-- Testimonials -->
			<div class="section-area section-sp2 bg-fix ovbl-dark" style="background-image:url(assets_User/images/background/bg1.jpg);">
                <div class="container">
					<div class="row">
					...
					<div class="testimonial-carousel owl-carousel owl-btn-1 col-12 p-lr0">
						<div class="item">
							<div class="testimonial-bx">
								<div class="testimonial-thumb">
									<img src="assets_User/images/testimonials/pic1.jpg" alt="">
								</div>
						...
						<div class="item">
							<div class="testimonial-bx">
								<div class="testimonial-thumb">
									<img src="assets_User/images/testimonials/pic2.jpg" alt="">
								</div>
								<div class="testimonial-info">
									<h5 class="name">Peter Packer</h5>
									<p>-Art Director</p>
					...
					<div class="recent-news-carousel owl-carousel owl-btn-1 col-12 p-lr0">
						<div class="item">
							<div class="recent-news">
								<div class="action-box">
									<img src="assets_User/images/blog/latest-blog/pic1.jpg" alt="">
								</div>
								<div class="info-bx">
									<ul class="media-post">
						...
						<div class="item">
							<div class="recent-news">
								<div class="action-box">
									<img src="assets_User/images/blog/latest-blog/pic2.jpg" alt="">
								</div>
								<div class="info-bx">
									<ul class="media-post">
						...
						<div class="item">
							<div class="recent-news">
								<div class="action-box">
									<img src="assets_User/images/blog/latest-blog/pic3.jpg" alt="">
								</div>
								<div class="info-bx">
									<ul class="media-post">
					...
					<div class="col-lg-4 col-md-12 col-sm-12 footer-col-4">
                        <div class="widget">
                            ...
                            <div class="subscribe-form m-b20">
								<form class="subscription-form" action="http://educhamp.themetrades.com/demo/assets_User/script/mailchamp.php" method="post">
					...
					<div class="col-12 col-lg-3 col-md-5 col-sm-12 footer-col-4">
                        <div class="widget widget_gallery gallery-grid-4">
                            ...
                            <ul class="magnific-image">
								<li><a href="assets_User/images/gallery/pic1.jpg" class="magnific-anchor"><img src="assets_User/images/gallery/pic1.jpg" alt=""></a></li>
								<li><a href="assets_User/images/gallery/pic2.jpg" class="magnific-anchor"><img src="assets_User/images/gallery/pic2.jpg" alt=""></a></li>
								<li><a href="assets_User/images/gallery/pic3.jpg" class="magnific-anchor"><img src="assets_User/images/gallery/pic3.jpg" alt=""></a></li>
								<li><a href="assets_User/images/gallery/pic4.jpg" class="magnific-anchor"><img src="assets_User/images/gallery/pic4.jpg" alt=""></a></li>
								<li><a href="assets_User/images/gallery/pic5.jpg" class="magnific-anchor"><img src="assets_User/images/gallery/pic5.jpg" alt=""></a></li>
								<li><a href="assets_User/images/gallery/pic6.jpg" class="magnific-anchor"><img src="assets_User/images/gallery/pic6.jpg" alt=""></a></li>
								<li><a href="assets_User/images/gallery/pic7.jpg" class="magnific-anchor"><img src="assets_User/images/gallery/pic7.jpg" alt=""></a></li>
								<li><a href="assets_User/images/gallery/pic8.jpg" class="magnific-anchor"><img src="assets_User/images/gallery/pic8.jpg" alt=""></a></li>
							</ul>
                        </div>
                    </div>
                </div>
...
<script src="${pageContext.request.contextPath}/assets_User/vendors/revolution/js/jquery.themepunch.tools.min.js"></script>
<script src="${pageContext.request.contextPath}/assets_User/vendors/revolution/js/jquery.themepunch.revolution.min.js"></script>
<!-- Slider revolution 5.0 Extensions  (Load Extensions only on Local File Systems !  The following part can be removed on Server for On Demand Loading) -->
<script src="${pageContext.request.contextPath}/assets_User/vendors/revolution/js/extensions/revolution.extension.actions.min.js"></script>
<script src="${pageContext.request.contextPath}/assets_User/vendors/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
<script src="${pageContext.request.contextPath}/assets_User/vendors/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script src="${pageContext.request.contextPath}/assets_User/vendors/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script src="${pageContext.request.contextPath}/assets_User/vendors/revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script src="${pageContext.request.contextPath}/assets_User/vendors/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script src="${pageContext.request.contextPath}/assets_User/vendors/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script src="${pageContext.request.contextPath}/assets_User/vendors/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script src="${pageContext.request.contextPath}/assets_User/vendors/revolution/js/extensions/revolution.extension.video.min.js"></script>
<script>
jQuery(document).ready(function() {
	...
	if(tpj("#rev_slider_486_1").revolution == undefined){
		...
		ttrevapi = tpj("#rev_slider_486_1").show().revolution({
			sliderType:"standard",
			jsFileLocation:"assets_User/vendors/revolution/js/",
