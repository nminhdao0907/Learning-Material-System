                            ...
                            <div id="confirm-modal" class="modal">
                                <div class="modal-content" id="deleteModal">
                                    ...
                                    <div style="display:flex;justify-content: space-between">
                                        <a class="btn btn-primary" id="delete-confirm" href="lesson?action=delete&lesson_id=${i.lesson_id}&page=${page}">Delete</a>  
                            ...
                            <div style="width: 96%;margin: auto">
                                <div class="action-container" style="margin-top: 15px; margin-bottom: 10px">
                                    ...
                                    <div class="search-box" style="display: flex; align-items: center; width: 80%;">
                                        <form action="lesson" method="get" class="row" style="line-height: 30px; width: 100%;">
                                            ...
                                            <!-- Subject Dropdown -->
                                            <select class="col-md-2" name="searchBySubject" style="border-radius: 5px; border: 1px solid #E9E9E9; padding: 0px; margin-left: 10px; width: 100px;">
                                            ...
                                            <!-- Chapter Dropdown -->
                                            <select class="col-md-2" name="searchByChapter" style="border-radius: 5px; border: 1px solid #E9E9E9; padding: 0px; margin-left: 5px; width: 100px;">
                                    ...
                                    <div class="adbutton" style="padding: 0; margin-left: auto">
                                        <div>
                                            ...
                                            <button style="background-color: #4c1864" class="button" type="button" data-toggle="modal" onclick="window.location.href = 'lesson?action=addScreen'"><i class="fa-solid fa-plus" style="padding-right:5px"></i>Add New</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button class="button mobile-action" onclick="window.location.href = 'lesson?action=addScreen';"style="width: 100%"><i class="fas fa-plus"></i>New Lesson</button>                                           
                                    ...
                                    <table id="userTable" style="max-width: 100%;max-height: 50px;margin-top: 10px;font-size: 15px">
                                        <thead>
                                            <tr class="row" style="font-size: 20px; font-family: sans-serif; line-height: 30px">
                                                <th class="col-md-1" style="text-align: center;padding: 10px" onclick="window.location.href = 'lesson?action=sort&type=lid&page=${page}&dasc=${dasc}'"><span>ID</span></i></th>
                                                <th class="col-md-2" style="text-align: center;padding: 10px" onclick="window.location.href = 'lesson?action=sort&type=title&page=${page}&tasc=${tasc}'"><span>Title</span></th>
                                                <th class="col-md-2" style="text-align: center;padding: 10px" onclick="window.location.href = 'lesson?action=sort&type=chapter_id&page=${page}&casc=${casc}'"><span>Chapter</span></th>
                                                <th class="col-md-2" style="text-align: center;padding: 10px" onclick="window.location.href = 'lesson?action=sort&type=subject_id&page=${page}&sasc=${sasc}'"><span>Subject</span></th>
                                                <th class="col-md-2" style="text-align: center;padding: 10px" onclick="window.location.href = 'lesson?action=sort&type=ltype&page=${page}&lasc=${lasc}'"><span>Lesson Type</span></th>
                                                <th class="col-md-2" style="text-align: center;padding: 10px" onclick="window.location.href = 'lesson?action=sort&type=status&page=${page}&acasc=${acasc}'"><span>Status</span></th>
                                        ...
                                        <form action="lesson" id="deleteLesson" method="get">
                                            ...
                                            <c:forEach items="${requestScope.listA}" var="i">
                                                ...
                                                <li class="list-inline-item">   
                                                    <a style="color: black;cursor: pointer" onclick="window.location.href = 'lesson?action=detailLesson&sid=${i.lesson_id}'" class="text-info" data-toggle="tooltip" title="View Details">
                                                        <i style="color: black" class="fa-solid fa-circle-info"></i>
                                                    </a>
                                                </li>
                                                <c:if test="${i.is_active == 0}">
                                                    <li class="list-inline-item">
                                                        <a href="#" style="color: green" onclick="window.location.href = 'lesson?action=activeAndDeactived&page=${page}&lesson_id=${i.lesson_id}'" title="Activate">
                                                ...
                                                <c:if test="${i.is_active == 1}">
                                                    <li class="list-inline-item">
                                                        <a href="#" style="color: red" onclick="window.location.href = 'lesson?action=activeAndDeactived&page=${page}&lesson_id=${i.lesson_id}'" title="Deactivate">
