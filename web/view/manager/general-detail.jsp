    ...
    <body class="ttr-opened-sidebar ttr-pinned-sidebar">
        ...
        <main class="ttr-wrapper">
            <div class="container">
                ...
                <form action="GeneralDetail" method="post">
                    <input type="hidden" name="formType" value="UpdateDimension"> <!-- Add this hidden field -->

                    <div class="form-group">
                        <input name="id" readonly type="text" class="form-control" hidden="" required="" value="${requestScope.d.id}">
                    </div>
                    Type:
                    ...
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control"  required="" value="${requestScope.d.name}">
                    </div>
                    Subject:
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input type="radio" name="status" id="activeRadio" value="1" ${requestScope.d.is_active == 1 ? 'checked' : ''}>
                            <label class="form-check-label" for="activeRadio">Active</label>
                        </div>
                        <div class="form-check">
                            <input type="radio" name="status" id="inactiveRadio" value="0" ${requestScope.d.is_active == 0 ? 'checked' : ''}>
                    ...
                    <button type="submit"style="background-color: #4c1864" class="btn btn-primary">Update</button>
                </form>
