<%-- 
    Document   : detail-setting
    Created on : Sep 24, 2023, 8:07:23 AM
    Author     : OS
--%>
                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            ...
                            <c:forEach items="${requestScope.settings}" var="i">
                                <div class="wc-title">
                                    <h5 style="display: inline; margin: 0; font-weight: lighter">Details of setting:</h5>
                                    <h4 style="display: inline; margin: 0; font-weight: bolder;">${i.setting_value}</h4>
                                </div>
                            </c:forEach>
                                ...
                                <table class="table1" border="1">
                                    <c:forEach items="${requestScope.settings}" var="i">
                                        ...
                                        <tr>
                                            ...
                                            <td class = "a" style="text-align: left">${i.setting_value}</td>
                                        </tr>
                                        <tr>
                                            <td class="col-sm-1" style="text-align: left">Type</td>
                                            <td class = "a" style="text-align: left">${i.setting_name}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="col-sm-1" style="text-align: left">Display Order</td>
                                            <td class = "a" style="text-align: left">${i.display_order}</td>
                                        </tr>
                                                                                <tr class="bigger-row">
    ...
    <tr>
        ...
        <td class="a" style="text-align: left">
            <fmt:formatDate value="${i.updated_at}" pattern="yyyy-MM-dd 'at' HH:mm:ss" />
                                        ...
                                        <script>
                                                function goToUpdate() {
        window.location.href = "settinglist?action=updateSet&id=${i.id}";
    }
                                            </script>
                                    </c:forEach>
                                </table>
