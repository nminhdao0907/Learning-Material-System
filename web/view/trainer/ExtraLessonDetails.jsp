        ...
        <main class="ttr-wrapper">
            <div class="container-fluid">
                <div class="db-breadcrumb">
                    <h4 class="breadcrumb-title">Extra Lesson Details</h4>
                    <ul class="db-breadcrumb-list">
                        <li><i class="fa fa-home"></i>Home</li>
                        <li><a href="exLesson?action=list">Manage Extra Lesson</a></li>
                        <li><a>Extra Lesson Details</a></li>
                    </ul>
                </div>
                ...
                &nbsp;&nbsp;&nbsp;<a href="exLesson?action=list" style="font-size: 15px"><strong>BACK TO LIST</strong></a>
                <div class="row">
                    <!-- Your Profile Views Chart -->
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            <div class="wc-title">
                                <h4>Extra Lesson Details</h4>
                            </div>
                            <div class="widget-inner">                               
                                <form action="exLesson" method="get" id="userForm" class="edit-profile m-b30">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="ml-auto">
                                                <h3>Basic info</h3>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input class="form-control" id="" style="background-color: white" type="text" name="chapter_id" value="${lesson.chapter.chapter_id} - ${lesson.chapter.title}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div> 
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" id="actRadio" name="is_active" value="1"  ${lesson.is_active == 1 ? 'checked' : ''}/>&nbsp;Active&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="radio" id="inactRadio" name="is_active" value="0" ${lesson.is_active == 0 ? 'checked' : ''}/>&nbsp;Inactive&nbsp;&nbsp;&nbsp;&nbsp;
                                            </div>
                                        </div>
